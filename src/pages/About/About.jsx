  ...
  return (
    <section id="about">
      <div id="about-container">
        <div id="me-picture">
          <img src="/profile.jpg" alt="Emerson Junior" />
      ...
      <div id="about-description">
        ...
        <div id="about-text">
          <p className="about-p">
            ...
            sempre existiu, desde quando passava horas refletindo sobre o que
            havia por trás dos softwares presentes no meu dia a dia. A ideia de
            buscar soluções inteligentes e inovadoras para problemas já
            existentes continua me motivando até hoje.
          </p>
          <p className="about-p">
            ...
            integração de APIs, metodologias ágeis (SCRUM), além de já ter
            desenvolvido no back-end com tecnologias como .NET e C#.
          </p>
